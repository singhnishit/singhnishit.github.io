...
![Cool-art](/assets/swarmblog/processed_media-ezgif.com-optimize.gif)
$$\text{INTERCONNECTED is a digital artwork that dramatically portrays the hidden troves of operational data at Charlotte Douglas International Airport (CLT) as an ever-changing suite of abstract form, color, and simulated texture.}$$
...
[^5]: [5] If I were a terrible person, I'd be happy that all the math majors I have interacted with now have to find a job elsewhere. I'm not a terrible person. ![mathjoke](/assets/swarmblog/MATHJOKE.png)
